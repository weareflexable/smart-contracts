 ...
 */
contract FlexableMarketplace is
    Context,
    ReentrancyGuard,
    ERC721Holder,
    ERC1155Holder,
    ERC2981
{
    ...
    modifier onlyOperator() {
        require(
            flexableRoles.isOperator(_msgSender()),
    ...
    constructor(
        ...
        flexableRoles = IFlexableAuth(flowContract);
    ...
    function _paymentSplit(
        ...
        address marketplacePayoutAddress = flexableRoles.getPayoutAddress();
